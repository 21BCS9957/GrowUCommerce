...
const StatsCard = ({ stat, description, icon: Icon }: StatsCardProps) => {
  ...
  return (
    <div
      ...
      className="group relative p-6 rounded-2xl bg-card/50 backdrop-blur border border-border hover:border-green-400/50 transition-all duration-300 hover:shadow-[0_0_30px_rgba(34,197,94,0.2)] animate-slide-up"
    >
      ...
      <div className="relative z-10 space-y-3">
        <div className="flex items-center justify-between">
          ...
          <div className="w-12 h-12 rounded-xl bg-green-400/10 flex items-center justify-center group-hover:bg-green-400 group-hover:scale-110 transition-all duration-300">
